...
# Attack the dataset
attack_results = Attacker(baerecipe, test_dataset, textattack.AttackArgs(num_examples=-1, log_to_csv="BaetRCNN.csv")).attack_dataset()
...
results[["original_text", "perturbed_text"]].to_html("./BaeRCNN_results.html", escape=False)
